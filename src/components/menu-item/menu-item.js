...
const MenuItem = ({ title, subtitle, imageUrl, history, linkUrl, match }) => (
  ...
  >
    <div className='flex justify-center items-center h-72 rounded-lg overflow-hidden relative group'>
      ...
      />
      <div className='rounded-lg w-36 h-24 flex justify-center items-center flex-col relative z-20 bg-slate-200 opacity-70 group-hover:opacity-100 transition duration-300 cursor-pointer'>
